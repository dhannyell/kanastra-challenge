...
class DebitUseCase:
    ...
    def _process_email_and_boleto_in_background(cls):
        ...
        debits_pending = Debit.get_debit_by_due_date(current_date, DebitRepository)

        Boleto.generate_boletos(debits_pending, BoletoService)

        Email.send_email(debits_pending, EmailService)
